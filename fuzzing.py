...
def create_hard_list():
    in_words = open("/Users/yurygornostaev/VisualcodeProjects /Nn_for_bot/Nn_for_bot/data_txt/trn/txt_2.txt").read().split('\n')
    res_words = open("").read().split('\n')
...
# # Для оптимизации обучения модели
